...
?>
  ...
  <body>
    ...
    <!--The below line is uncommented while deploying Version 2-->
    <!--<div style="background-color: #990011; color: white; font-size: 20px; font-weight: bold; padding: 10px; text-align: center;">
      <marquee behavior="scroll" direction="left" scrollamount="6">
        "Every donor is a hero. Register now!"
      </marquee>
    </div>-->
